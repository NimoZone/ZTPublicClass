#
#  Be sure to run `pod spec lint ZTPublicClass.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/NimoZone/ZTPublicClass.git", :tag => "#{s.version}" }
